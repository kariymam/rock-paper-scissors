...
let user = { name: "You", score: 0, winner: () => (user.score >= parseInt(inputValue.value, 10) && user.score > computer.score) };
let computer = { name: "Computer", score: 0, winner: () => (computer.score >= parseInt(inputValue.value, 10) && computer.score > user.score) };
